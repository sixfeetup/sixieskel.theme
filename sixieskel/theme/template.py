...
class SixieTheme(Plone3Theme):
    ...
    get_var(vars, 'namespace_package').description = (
        'Namespace package (like plonetheme or Products)')
    get_var(vars, 'namespace_package').description = (
        'Namespace package (like plonetheme or Products)')
    get_var(vars, 'namespace_package').default = 'Products'
    get_var(vars, 'package').description = (
        'The package contained namespace package (like policy or theme)')
    ...
    get_var(vars, 'skinname').description = (
        'The skin selection to be added to portal_skins (like SFUP Theme)')
